...
def add_new_pilot(connection, cursor):
    ...
    pilot_id = conformed_id_input("Please provide pilot ID (e.g., P001):, ", r"^[A-Z]{1}[0-9]{3}$", "e.g., P001")
    ...
    license_id = conformed_id_input("Please provide license ID (e.g., PLI001): ", r"^[A-Z]{3}[0-9]{3}$", "e.g., PLI001")
    first_name = non_empty_input("First name: ")
    last_name = non_empty_input("Last name: ")

    # Provide a rank of the pilot
    input_rank = boolean_input("What is the pilot's rank (Select 1 for Captain, 2 for First Officer): ", "1/2")
...
def view_pilot_schedule(cursor):
    ...
    pilot_id = conformed_id_input("Enter Pilot ID: ", r"^[A-Z]{1}[0-9]{3}$", "e.g., P001")
...
def assign_pilot_to_flight(connection, cursor):
    ...
    role_choice = boolean_input("Which role to assign? (Select 1 for Captain, 2 for First Officer): ", "1/2")
